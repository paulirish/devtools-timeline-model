...
class SandboxedModel {
  ...
  topDown() {
    return this.topDownGroupedBy(TimelineModel.TimelineAggregator.GroupBy.None);
  }

  topDownGroupedBy(grouping) {
    var filters = [];
    ...
    var groupSetting = TimelineModel.TimelineAggregator.GroupBy[grouping];
  ...
  bottomUp() {
    return this.bottomUpGroupBy(TimelineModel.TimelineAggregator.GroupBy.None);
  }
  ...
  bottomUpGroupBy(grouping) {
    var topDown = this.topDownGroupedBy(grouping);
