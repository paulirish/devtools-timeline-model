...
class SandboxedModel {
  ...
  topDown(opts) {
    return this.topDownGroupBy(Timeline.AggregatedTimelineTreeView.GroupBy.None, opts.startTime, opts.endTime);
  }
  ...
  topDownGroupBy(grouping, opts) {
    ...
    const topDownGrouped = TimelineModel.TimelineProfileTree.buildTopDown(this._timelineModel.mainThreadEvents(),
      filters, opts.startTime, opts.endTime, groupingAggregator);
  ...
  bottomUp(opts) {
    return this.bottomUpGroupBy(Timeline.AggregatedTimelineTreeView.GroupBy.None, opts.startTime, opts.endTime);
  }

  /**
   * @param  {!string} grouping Allowed values: None Category Subdomain Domain URL EventName
   * @param  {object} opts Options for startTime, endTime, and including all events
   * @return {!TimelineModel.TimelineProfileTree.Node} A grouped and sorted tree
   */
  bottomUpGroupBy(grouping, opts) {
    const topDown = this.topDownGroupBy(grouping, opts);
