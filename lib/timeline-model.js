...
/* global WebInspector TimelineModel SDK Bindings Timeline Components TimelineModelTreeView */
...
class SandboxedModel {
  ...
  topDown(eventIdCallback) {
    ...
    return TimelineModel.TimelineProfileTree.buildTopDown(this._timelineModel.mainThreadEvents(),
