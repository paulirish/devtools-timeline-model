...
this.WebInspector = {}; // might prefer being a var

this.Runtime = {}
this.TimelineModelTreeView = {};
this.TreeElement = {}
this.WorkerRuntime = {}
this.Protocol = {}
...
req('chrome-devtools-frontend/front_end/common/Object.js')
req('chrome-devtools-frontend/front_end/common/SegmentedRange.js')
req('chrome-devtools-frontend/front_end/platform/utilities.js')
req('chrome-devtools-frontend/front_end/sdk/Target.js')
req('chrome-devtools-frontend/front_end/bindings/TempFile.js')
req('chrome-devtools-frontend/front_end/sdk/TracingModel.js')
req('chrome-devtools-frontend/front_end/timeline/TimelineJSProfile.js')
req('chrome-devtools-frontend/front_end/timeline/TimelineUIUtils.js')
req('chrome-devtools-frontend/front_end/sdk/CPUProfileDataModel.js')
req('chrome-devtools-frontend/front_end/timeline/LayerTreeModel.js')
req('chrome-devtools-frontend/front_end/timeline/TimelineModel.js')
req('chrome-devtools-frontend/front_end/timeline/TimelineTreeView.js')
req('chrome-devtools-frontend/front_end/ui_lazy/SortableDataGrid.js')
req('chrome-devtools-frontend/front_end/timeline/TimelineProfileTree.js')
req('chrome-devtools-frontend/front_end/components_lazy/FilmStripModel.js')
req('chrome-devtools-frontend/front_end/timeline/TimelineIRModel.js')
req('chrome-devtools-frontend/front_end/timeline/TimelineFrameModel.js')

// minor configurations
req('../lib/devtools-init.js')
// polyfill the bottom-up and topdown tree sorting
req('../lib/timeline-model-treeview.js')
